...
class Sidebar(ctk.CTkFrame):
    """
    Vertical sidebar containing navigation buttons.
    Calls on_navigate(page_name) when a button is clicked.
    """
    ...
    def _build(self):
        ...
        for icon, name in NAV_ITEMS:
            btn = ctk.CTkButton(
                ...
                command=lambda n=name: self._click(n),
            )
        ...
        ctk.CTkLabel(
            self,
            text="v1.0.0  •  Numerical Analysis",
            text_color=TEXT_SEC,
